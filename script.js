document.addEventListener("DOMContentLoaded", function () {
  ...
  // 5. Tema oscuro/claro
  // -------------------------------
  const themeToggles = document.querySelectorAll(".theme-toggle"); // Selecciona AMBOS botones por su clase
  ...
  // Alternar tema al hacer clic (funciona para AMBOS botones)
  themeToggles.forEach((toggle) => {
    toggle.addEventListener("click", () => {
      ...
      updateIcon(); // La función updateIcon ya actualiza todos
    });
  });

  // Actualizar icono según el tema (actualiza AMBOS botones)
  function updateIcon() {
    const isDark =
